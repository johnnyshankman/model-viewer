...
import { Group, TextureFilter, Wrapping, Object3D, Material as Material$4, Texture as Texture$4, Vector3 as Vector3$1, Mesh as Mesh$1, WebGLRenderer, Scene as Scene$1, PerspectiveCamera as PerspectiveCamera$1, Camera as Camera$2, Event, Box3, Sphere, Vector2, AnimationActionLoopStyles, Raycaster, EventDispatcher, TextureLoader, Intersection, MeshStandardMaterial } from 'three';
...
declare type GLTFElement$1 = Scene | Node$2 | Mesh | Material$3 | Image$3 | Texture$3 | TextureInfo$3 | Sampler$3 | PBRMetallicRoughness$3 | Accessor | Camera$1 | Animation$1 | AnimationSampler | Skin$1;
interface Asset {
    version: '2.0';
    copyright?: string;
    generator?: string;
...
declare class Hotspot extends CSS2DObject {
    ...
    updateSurface(forceUpdate: boolean): void;
...
declare class ModelScene extends Scene$1 {
    ...
    hitFromPoint(ndcPosition: Vector2, object?: Object3D): three.Intersection<Object3D<Event>> | undefined;
    /**
     ...
     */
    initializeSurface(hotspot: Hotspot): void;
    /**
     * Update positions of surface hotspots to follow model animation.
     */
    updateSurfaceHotspots(): void;
    /**
...
declare class TextureUtils extends EventDispatcher {
    ...
    loadImage(url: string): Promise<Texture$4>;
    loadLottie(url: string, quality: number): Promise<Texture$4>;
    loadEquirect(url: string, progressCallback?: (progress: number) => void): Promise<Texture$4>;
    /**
...
declare type InteractionPromptStyle = 'basic' | 'wiggle';
