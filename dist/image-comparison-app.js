 ...
 */
const t$1=window,e$3=t$1.ShadowRoot&&(void 0===t$1.ShadyCSS||t$1.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s$3=Symbol(),n$4=new WeakMap;class o$4{constructor(t,e,n){if(this._$cssResult$=!0,n!==s$3)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e;}get styleSheet(){let t=this.o;const s=this.t;if(e$3&&void 0===t){const e=void 0!==s&&1===s.length;e&&(t=n$4.get(s)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),e&&n$4.set(s,t));}return t}toString(){return this.cssText}}const r$2=t=>new o$4("string"==typeof t?t:t+"",void 0,s$3),S$1=(s,n)=>{e$3?s.adoptedStyleSheets=n.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):n.forEach((e=>{const n=document.createElement("style"),o=t$1.litNonce;void 0!==o&&n.setAttribute("nonce",o),n.textContent=e.cssText,s.appendChild(n);}));},c$1=e$3?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return r$2(e)})(t):t;
...
const PIXEL_SIZE = 10;
class MagnifyingGlass extends s {
    constructor() {
        super(...arguments);
...
class Images4Up extends s {
    ...
    render() {
        const { x: x$1, y, width, height } = this.containerRect;
        return x `
<style>
:host {
  display: block;
...
<div id="container"
    ...
    style="transform: translate(${x$1}px, ${y}px);
           width: ${width}px;
           height: ${height}px">
...
<button @click="${() => this.reset()}" class="no-border">
  Clear selections
            ...
            instructions = x `<p>Select two images to compare them!</p>`;
        }
        return x `
<style>
:host {
...
class RenderingScenario extends s {
    constructor() {
        super(...arguments);
        this.name = '';
        this.goldens = [];
    ...
    async connectedCallback() {
        ...
        this.shadowRoot.addEventListener('click', (event) => {
            const originatingElement = event.target;
            if (originatingElement == null || originatingElement.tagName !== 'IMG') {
                return;
            }
            this.dispatchEvent(new CustomEvent('select', { detail: { element: originatingElement } }));
        });
    }
    ...
    metricTemplate(analysisResults, goldenName) {
        ...
        return x ` <span>${rmsInDecibel} dB </span>
      <div class="tooltip">
...
class ImageComparisonApp extends s {
    constructor() {
        super(...arguments);
        this.src = '';
        this.config = null;
    ...
    render() {
        const { config } = this;
        if (config == null) {
            return this.src ? x `Loading...` : x `No config specified`;
        }
        const goldens = config.renderers.map(renderer => ({ ...renderer, file: `${renderer.name}-golden.png` }));
        const scenarios = config.scenarios.map((scenario) => x `
...
__decorate([
    i('analysis-view')
], ImageComparisonApp.prototype, "analysisView", void 0);
